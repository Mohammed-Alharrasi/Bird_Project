...
func physics_movement(delta: float, player_body: XRToolsPlayerBody, disabled: bool):
	...
	var joy_forwards := _controller.get_vector2("thumbstick").y
	var joy_side := _controller.get_vector2("thumbstick").x
...
#	player_body.velocity = -_camera.transform.basis.z * speed_scale;
	return
